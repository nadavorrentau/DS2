...
public class FibonacciHeap1
{
    ...
    public FibonacciHeap1() { //Create an empty FibHeap. Complexity: O(1)
        First = null;
        Min = null;
        totalSize = 0;
    }

    public FibonacciHeap1(HeapNode root) { //Create a rank 1 FibHeap. Complexity: O(1)
        First = root;
        Min = First;
    ...
    */
    public HeapNode insert(int key)    { //Complexity: O(1)
        ...
        FibonacciHeap1 singularHeap = new FibonacciHeap1(newNode);
    ...
    */
    ...
    public void consolidate() {
        FibonacciHeap1 consolidated = new FibonacciHeap1();
        FibonacciHeap1[] forest = new FibonacciHeap1[this.maxRank()];

        HeapNode r = First.getNext();
        forest[First.getDegree()] = new FibonacciHeap1(First);

        while (r != this.First) { //successive linking
            boolean moveOn = false;
            HeapNode tmp = r.getNext();
            FibonacciHeap1 union = new FibonacciHeap1(r);
            while (!moveOn) {
        ...
        for (FibonacciHeap1 tree: forest) {
    ...
    */
    ...
    public void meld (FibonacciHeap1 heap2) { //Complexity: O(1)
    ...
    */
    ...
    public HeapNode cut(HeapNode x) { //sever x from his father and return the father if cut should continue
        ...
        this.meld(new FibonacciHeap1(x)); //meld the freshly cut sapling to the heap
    ...
    */
    public static int[] kMin(FibonacciHeap1 H, int k)
    {    
        int[] arr = new int[100];
